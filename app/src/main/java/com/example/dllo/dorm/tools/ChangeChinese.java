...
public class ChangeChinese {
    ...
    private static ChangeChinese characterParser = new ChangeChinese();

    public static ChangeChinese getInstance() {
    ...
    public String getSpelling(String s) {
        return this.getSelling(s);
    }
